var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
         maxZoom: 25, minZoom: 7, projection: new ol.proj.Projection({
            code: 'EPSG:4326',
...
map.getView().fit([-80.756551, -0.696413, -77.127880, 1.258578], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_Terrestrial_ecoregions_6,
    colName: 'ECO_NAME',
    zoom: 10,
    collapsed: true,
    map: map
